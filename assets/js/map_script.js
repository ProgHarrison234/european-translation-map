$(document).ready(function () {
	...
	let countryList = ["Br", "Sp", "Fr", "It", "Nl", "Hu", "Ru", "Uk", "De", "Pl", "El", "Pt", "Cs", "Hr", "Sr", "Bg", "Da", "No", "Sv", "Lt", "Lv", "Et", "Fi"];
	 ...
	 let keymap = ["English", "Spanish", "French", "Italian", "Dutch", "Hungarian", "Russian","Ukrainian", "German", "Polish", "Greek", "Portuguese", "Czech", "Croatian", "Serbian", "Bulgarian", "Danish", "Norwegian", "Swedish", "Lithuanian", "Latvian", "Estonian", "Finland"]
